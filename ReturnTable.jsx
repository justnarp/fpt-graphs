...
for (var countryCounter=0; countryCounter < countries.length; countryCounter++) {             
            for (var graphsCounter=0; graphsCounter < graphs.length; graphsCounter++) { 

var saveFolderAddress = "H:\\Graphs\\201403\\NewGraphs\\";
...
// Save the picture
var fileName = "RB_capdevb_s";
if (graphs[graphsCounter] == "con") {fileName = fileName + "_con_"};
if (graphs[graphsCounter] == "mod") {fileName = fileName + "_mod_"};
if (graphs[graphsCounter] == "bal") {fileName = fileName + "_bal_"};
if (graphs[graphsCounter] == "gro") {fileName = fileName + "_gro_"};
if (graphs[graphsCounter] == "rf") {fileName = fileName + "_rf_"};
if (graphs[graphsCounter] == "rf_plus") {fileName = fileName + "_rf_plus_"};
if (countries[countryCounter] == "DK") {
    if(graphs[graphsCounter] != "rf_plus") {
	saveFolder = saveFolderAddress + "DK/";
	...
	var fileName1 = fileName + "daDK.png";
	var saveFile1 = File(saveFolder + "/" + fileName1);
	if(saveFile1.exists){saveFile1.remove();}
	savePicture(saveFile1);
	...
	var fileName2 = fileName + "enDK.png";
	var saveFile2 = File(saveFolder + "/" + fileName2);
	if(saveFile2.exists){saveFile2.remove();}
	savePicture(saveFile2);
    }
	
	//alert("Saved " + fileName1 + " and " + fileName2 + " at " + saveFolder);
};
if (countries[countryCounter] == "SE") {
    if(graphs[graphsCounter] != "rf_plus") {
	saveFolder = saveFolderAddress + "SE/";
	app.activeDocument.layers.getByName("year3Text").textItem.contents = "3 år";
	app.activeDocument.layers.getByName("year6Text").textItem.contents = "6 år";
	app.activeDocument.layers.getByName("year10Text").textItem.contents = "10 år";
	...
	var fileName1 = fileName + "svSE.png";
	var saveFile1 = File(saveFolder + "/" + fileName1);
	if(saveFile1.exists){saveFile1.remove();}
	savePicture(saveFile1);
	...
	app.activeDocument.layers.getByName("expReturnText").textItem.contents = "Expected return";
	app.activeDocument.layers.getByName("maxReturnText").textItem.contents = "Max. return";
	var fileName2 = fileName + "enSE.png";
	var saveFile2 = File(saveFolder + "/" + fileName2);
	if(saveFile2.exists){saveFile2.remove();}
	savePicture(saveFile2);
    }
...
if (countries[countryCounter] == "NO") {
	saveFolder = saveFolderAddress + "NO/";
	app.activeDocument.layers.getByName("year3Text").textItem.contents = "3 år";
	app.activeDocument.layers.getByName("year6Text").textItem.contents = "6 år";
	app.activeDocument.layers.getByName("year10Text").textItem.contents = "10 år";
	app.activeDocument.layers.getByName("maxLossText").textItem.contents = "Min. avkastning";
	...
	var fileName1 = fileName + "noNO.png";
	var saveFile1 = File(saveFolder + "/" + fileName1);
	if(saveFile1.exists){saveFile1.remove();}
	savePicture(saveFile1);
	...
	app.activeDocument.layers.getByName("expReturnText").textItem.contents = "Expected return";
	app.activeDocument.layers.getByName("maxReturnText").textItem.contents = "Max. return";
	var fileName2 = fileName + "enNO.png";
	var saveFile2 = File(saveFolder + "/" + fileName2);
	if(saveFile2.exists){saveFile2.remove();}
	savePicture(saveFile2);
...
if (countries[countryCounter] == "FI") {
    if(graphs[graphsCounter] != "rf_plus") {
	saveFolder = saveFolderAddress + "FI/";
	...
	var fileName1 = fileName + "fiFI.png";
	var saveFile1 = File(saveFolder + "/" + fileName1);
	if(saveFile1.exists){saveFile1.remove();}
	savePicture(saveFile1);
	...
	app.activeDocument.layers.getByName("expReturnText").textItem.contents = "Förväntad avkastning";
	app.activeDocument.layers.getByName("maxReturnText").textItem.contents = "Max. avkastning";
	var fileName2 = fileName + "svFI.png";
	var saveFile2 = File(saveFolder + "/" + fileName2);
	if(saveFile2.exists){saveFile2.remove();}
	savePicture(saveFile2);
	...
	app.activeDocument.layers.getByName("expReturnText").textItem.contents = "Expected return";
	app.activeDocument.layers.getByName("maxReturnText").textItem.contents = "Max. return";
	var fileName3 = fileName + "enFI.png";
	var saveFile3 = File(saveFolder + "/" + fileName3);
	if(saveFile3.exists){saveFile3.remove();}
	savePicture(saveFile3);
	}
	//alert("Saved " + fileName1 + " and " + fileName2 + " and " + fileName3 + " at " + saveFolder);
};
