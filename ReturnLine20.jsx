...
// In Photoshop, open the Return Line Graph 3-6-10.psd file.
...
// In Photoshop, go to File/Save for Web & Devices, save as PNG-24 format. Name something like RB_capdevl_l_con_daDK.png for Conservative danish DK.
...
var xAxisPosition2Years = 20 + (graphDimensionX/19);
var xAxisPosition3Years = 20 + (graphDimensionX/19)*2;
var xAxisPosition4Years = 20 + (graphDimensionX/19)*3;
var xAxisPosition5Years = 20 + (graphDimensionX/19)*4;
var xAxisPosition6Years = 20 + (graphDimensionX/19)*5;
var xAxisPosition7Years = 20 + (graphDimensionX/19)*6;
var xAxisPosition8Years = 20 + (graphDimensionX/19)*7;
var xAxisPosition9Years = 20 + (graphDimensionX/19)*8;
var xAxisPosition10Years = 20 + (graphDimensionX/19)*9;
var xAxisPosition11Years = 20 + (graphDimensionX/19)*10;
var xAxisPosition12Years = 20 + (graphDimensionX/19)*11;
var xAxisPosition13Years = 20 + (graphDimensionX/19)*12;
var xAxisPosition14Years = 20 + (graphDimensionX/19)*13;
var xAxisPosition15Years = 20 + (graphDimensionX/19)*14;
var xAxisPosition16Years = 20 + (graphDimensionX/19)*15;
var xAxisPosition17Years = 20 + (graphDimensionX/19)*16;
var xAxisPosition18Years = 20 + (graphDimensionX/19)*17;
var xAxisPosition19Years = 20 + (graphDimensionX/19)*18;
var xAxisPosition20Years = 20 + graphDimensionX;
...
positionLayerCenter("minReturn20YearsDot", xAxisPosition20Years, calculateYAxisPixels(minReturn[19]));
...
app.activeDocument.layers.getByName("minReturn20YearsText").textItem.contents = Math.round(minReturn[19]) + "%";
...
positionLayerCenter("minReturn20YearsText", xAxisPosition20Years, calculateYAxisPixels(minReturn[19]));
...
app.activeDocument.layers.getByName("minReturn20YearsText").translate(-19,12);
...
positionLayerCenter("expReturn20YearsDot", xAxisPosition20Years, calculateYAxisPixels(expReturn[19]));
...
app.activeDocument.layers.getByName("expReturn20YearsText").textItem.contents = Math.round(expReturn[19]) + "%";
...
positionLayerCenter("expReturn20YearsText", xAxisPosition20Years, calculateYAxisPixels(expReturn[19]));
...
app.activeDocument.layers.getByName("expReturn20YearsText").translate(-19,-8);
...
positionLayerCenter("maxReturn20YearsDot", xAxisPosition20Years, calculateYAxisPixels(maxReturn[19]));
...
positionLayerCenter("maxReturn20YearsText", xAxisPosition20Years, calculateYAxisPixels(maxReturn[19]));
...
app.activeDocument.layers.getByName("maxReturn20YearsText").translate(-19,-8);
...
if(highestValueInPercent < 90){
	...
	app.activeDocument.layers.getByName("yAxis100PercentText").textItem.contents = "1000%";
	positionLayerCenter("yAxis100PercentLine", xAxisPosition1Years, calculateYAxisPixels(1000));
	positionLayerCenter("yAxis100PercentText", xAxisPosition1Years + 20, calculateYAxisPixels(1000));
} else if(highestValueInPercent > 500) {
	app.activeDocument.layers.getByName("yAxis100PercentText").textItem.contents = "500%";
	positionLayerCenter("yAxis100PercentLine", xAxisPosition1Years, calculateYAxisPixels(500));
	positionLayerCenter("yAxis100PercentText", xAxisPosition1Years + 20, calculateYAxisPixels(500));
} else if(highestValueInPercent > 250) {
	app.activeDocument.layers.getByName("yAxis100PercentText").textItem.contents = "250%";
	positionLayerCenter("yAxis100PercentLine", xAxisPosition1Years, calculateYAxisPixels(250));
	positionLayerCenter("yAxis100PercentText", xAxisPosition1Years + 20, calculateYAxisPixels(250));
} else {
...
positionLayerCenter("xAxis20YearLine", xAxisPosition20Years, graphDimensionY/2 + 20);
...
app.activeDocument.layers.getByName("xAxis20YearText").textItem.contents = "20 " + translationYear;
...
positionLayerCenter("xAxis20YearText", xAxisPosition20Years - 2, 23);
...
// 10-20 years, up
deleteLayer("blueGradientUp10-20");
selectLayer("blueGradient");
duplicateLayer("blueGradient", "blueGradientUp10-20");
app.activeDocument.artLayers.getByName("blueGradientUp10-20").visible = true;
gradientWidth = xAxisPosition20Years - xAxisPosition10Years;
gradientHeight = calculateYAxisPixels(expReturn[19]) - calculateYAxisPixels(maxReturn[19]);
resizeLayer("blueGradientUp10-20", gradientWidth, gradientHeight);
positionLayerTopRight("blueGradientUp10-20", xAxisPosition20Years, calculateYAxisPixels(maxReturn[19]));
// 1-3 years, down
...
// 10-20 years, down
deleteLayer("blueGradientDown10-20");
selectLayer("blueGradient");
duplicateLayer("blueGradient", "blueGradientDown10-20");
app.activeDocument.artLayers.getByName("blueGradientDown10-20").visible = true;
gradientWidth = xAxisPosition20Years - xAxisPosition10Years;
gradientHeight = calculateYAxisPixels(expReturn[19]) - calculateYAxisPixels(minReturn[19]);
resizeLayer("blueGradientDown10-20", gradientWidth, gradientHeight);
positionLayerTopRight("blueGradientDown10-20", xAxisPosition20Years, calculateYAxisPixels(expReturn[19]));
